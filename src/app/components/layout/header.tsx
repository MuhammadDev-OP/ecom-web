...
export default function Header() {
  return (
    <>
      <Wrapper>
        <header className="flex justify-between max-w-screen-xl mx-auto pt-6 pb-4 items-center">
          ...
          <div className="w-[400px] border-gray-300 rounded flex relative items-center space-x-2">
